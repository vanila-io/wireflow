...
(function($,_){
  ...
  _.show = function() {
    ...
    if(windowHeight < (contextMenuHeight + contextMenuOffset.top + 20)){
      var _top = contextMenuTop - ((contextMenuHeight + contextMenuOffset.top + 20) - windowHeight);
    ...
    if(windowWidth < (contextMenuWidth + contextMenuOffset.left + 20)){
      var _left = contextMenuLeft - ((contextMenuWidth + contextMenuOffset.left + 20) - windowWidth);
      _options.container.css({
        left : _left
      });
    }
