...
export class Controls extends React.Component {
  ...
  handeCheckBoxChange(event) {
    ...
    this.setState({
      ...
      statusFilter = !statusFilter && this.state.inactive ? 'inactive' : statusFilter;
      statusFilter = !statusFilter && this.state.active ? 'active' : statusFilter;
      this.props.onTriggerStatusSearch(this.refs.searchInput.value, statusFilter);
    });
  }
