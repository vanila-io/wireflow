...
export class BillingInfo extends React.Component {
  setComponentStates(props) {
    ...
    this.state = {
      _id: user._id,
      address: !theSameWithProfile ? billingInfo.address : user.profile.address || '',
  ...
  renderInfoOrCheckbox() {
    if (this.state.is_same_with_user) {
      return (
        <div className="checkbox">
          ...
          <p><button className="btn btn-sm" onClick={this.handleNewAddress.bind(this)}>
            Use another address
          </button></p>
        </div>
      );
    ...
    return (
      <div>
        <button className="btn btn-sm" onClick={this.handleNewAddress.bind(this)}>
          Use another address
        </button>
  ...
  renderForm() {
    return (<div>
      ...
      <button className="btn btn-secondary"
        onClick={this.handleUseProfileAddress.bind(this)}>Use my profile address
      </button>
